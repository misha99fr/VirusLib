...
layout:addChild(GUI.text(8, 8, 0x4B4B4B, "Удалён"))
...
layout:addChild(GUI.text(12, 12, 0x4B4B4B, "Отсутствует"))
layout:addChild(GUI.text(13, 13, 0x4B4B4B, "Отсутствует"))
layout:addChild(GUI.text(14, 14, 0x4B4B4B, "Отсутствует"))
layout:addChild(GUI.text(15, 15, 0x33DB40, "Version 1.20 | Lase base update: 08.08.2024"))
